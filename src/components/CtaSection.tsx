      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        >
          ...
          <a
            ...
            className="group inline-flex items-center gap-2 bg-primary text-primary-foreground px-8 py-4 rounded-xl font-semibold text-lg hover:shadow-[0_0_40px_hsl(170_80%_38%/0.4)] transition-all duration-300 hover:scale-105"
          >
