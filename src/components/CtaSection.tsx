      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        >
          ...
          <a
            ...
            className="group inline-flex items-center gap-2 bg-primary text-primary-foreground px-8 py-4 rounded-xl font-semibold text-lg animate-pulse-glow motion-reduce:!animate-none hover:scale-105 transition-transform duration-300"
          >
