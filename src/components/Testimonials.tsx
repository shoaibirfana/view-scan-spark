...
const testimonials: Testimonial[] = [
  ...
  { quote: "From LLC formation to EIN filing, Team Ecomify made the entire process seamless. I had my business legally set up within a week and was ready to start selling on Amazon right away.", name: "Sarah Mitchell", role: "LLC & Business Setup" },
  { quote: "Their Shopify store design was incredible — clean, conversion-focused, and mobile-optimized. My bounce rate dropped by 40% and my average order value went up significantly.", name: "James Rodriguez", role: "Shopify Store" },
  { quote: "I was losing money on ads before Team Ecomify took over my PPC campaigns. They restructured everything and within 6 weeks my ACoS dropped from 45% to 18%. Absolutely worth every penny.", name: "Amanda Brooks", role: "Amazon PPC" },
  { quote: "Team Ecomify sourced winning products for my TikTok Shop that perfectly matched trending content. My first viral video generated over $12K in sales in just 48 hours.", name: "Chris Patterson", role: "Product Sourcing" },
  { quote: "Their team helped me recover my suspended Amazon account in under 5 days. I thought my business was over, but they drafted the perfect appeal and got me reinstated quickly.", name: "Rachel Kim", role: "Account Recovery" },
  { quote: "I've worked with multiple agencies before, but Team Ecomify is on another level. They don't just set things up — they actually care about your growth and follow through on every detail.", name: "Brandon Harris", role: "Full-Service Client" },
  { quote: "The ITIN number process felt so complicated until Team Ecomify walked me through it. They handled all the paperwork and I received my ITIN faster than I expected.", name: "Natalie Cooper", role: "ITIN Filing" },
  { quote: "Team Ecomify built my entire brand from the ground up — logo, packaging, A+ Content, and storefront. My products now look premium and my conversion rate has never been higher.", name: "Tyler Washington", role: "Brand Building" },
];
    ...
    <div className="relative z-10 flex flex-col flex-1">
      ...
      <div className="flex items-center gap-3">
        {t.img ? (
          ...
          <div className={`w-10 h-10 rounded-full flex items-center justify-center font-semibold text-sm ring-2 ring-primary/20 ${avatarColors[index % avatarColors.length]}`}>
            {getInitials(t.name)}
          </div>
        )}
        <div>
...
=======
          <h2 className="text-3xl sm:text-4xl font-heading font-bold mb-4 mt-4">What Our Clients Have To Say</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Many of our students and clients have built successful online brands, earning consistent revenue and transitioning into full-time entrepreneurship.
>>>>>>> 05217bc72bdcf6146af743a93749a67c87328a73
          </p>
        </motion.div>
      </div>
